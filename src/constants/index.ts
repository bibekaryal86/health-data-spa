...
export const MSG_KEY_CHECKUP_RESULT_FIND_ERROR = 'RESULT_FIND_ERROR'
export const MSG_KEY_CHECKUP_RESULT_INSERT_ERROR = 'RESULT_INSERT_ERROR'
export const MSG_KEY_CHECKUP_RESULT_INSERT_SUCCESS = 'RESULT_INSERT_SUCCESS'
export const MSG_KEY_CHECKUP_RESULT_UPDATE_ERROR = 'RESULT_UPDATE_ERROR'
export const MSG_KEY_CHECKUP_RESULT_UPDATE_SUCCESS = 'RESULT_UPDATE_SUCCESS'
export const MSG_KEY_CHECKUP_RESULT_DELETE_ERROR = 'RESULT_DELETE_ERROR'
export const MSG_KEY_CHECKUP_RESULT_DELETE_SUCCESS = 'RESULT_DELETE_SUCCESS'
